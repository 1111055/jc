              ...
              <div class="content-wrapper">
                ...
                <section class="content-header">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="{{route('familia')}}"><i class="fa fa-circle-o"></i> Familia</a></li>
                  </ol>
                </section>
                            ...
                            <!-- Horizontal Form -->
                              <div class="col-xs-12">
                                <div class="box box-info">
                                  {!! Form::open(['url' => 'familia','class' => 'form-horizontal']) !!}
                                        <div class="box-body">
                          ...
                          <table class="table table-hover">
                            ...
                            @foreach($familia as $item)
                              <tr>
                                ...
                                @endif   
                                <td><a href="{{route('familia.edit',$item->id)}}" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></a> 

                                    {{ Form::open(['route' => ['familia.destroy', $item->id], 'method' => 'delete']) }}
